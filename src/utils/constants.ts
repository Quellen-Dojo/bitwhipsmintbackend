export const landevoDirtyVersions: DirtyVersionTable = {
  Body: {
    ...
    "Blue Carbon": [
      "Blue Carbon Dirty",
      "Blue Carbon Patina Dirty",
      "Blue Carbon Patina",
    ],
    "Blue Clean": ["Blue Dirty", "Blue Patina Dirty", "Blue Patina"],

    "Crimson Carbon": [
      "Crimson Carbon Dirty",
      "Crimson Carbon Patina Dirty",
      "Crimson Carbon Patina",
    ],
    "Crimson Clean": [
      "Crimson Dirty",
      "Crimson Patina Dirty",
      "Crimson Patina",
    ],

    "Dusk Carbon": [
      "Dusk Carbon Dirty",
      "Dusk Carbon Patina Dirty",
      "Dusk Carbon Patina",
    ],
    ...
    "Orange Carbon": [
      "Orange Carbon Dirty",
      "Orange Carbon Patina Dirty",
      "Orange Carbon Patina",
    ],
    "Orange Clean": ["Orange Dirty", "Orange Patina Dirty", "Orange Patina"],

    "Pink Carbon": [
      "Pink Carbon Dirty",
      "Pink Carbon Patina Dirty",
      "Pink Carbon Patina",
    ],
    ...
    "Purple Carbon": [
      "Purple Carbon Dirty",
      "Purple Carbon Patina Dirty",
      "Purple Carbon Patina",
    ],
    "Purple Clean": ["Purple Dirty", "Purple Patina Dirty", "Purple Patina"],

    "Teal Carbon": [
      "Teal Carbon Dirty",
      "Teal Carbon Patina Dirty",
      "Teal Carbon Patina",
    ],
...
export const teslerrDirtyVersions: DirtyVersionTable = {
  Bodys: {
    ...
    "Blue Clean Carbon": [
      "Blue Dirty Carbon",
      "Blue Dirty Patina Carbon",
      "Blue Patina Carbon",
    ],
    "Blue Clean": ["Blue Dirty", "Blue Patina"],

    "Blue Fade Clean Carbon": [
      "Blue Fade Dirty Carbon",
      "Blue Fade Dirty Patina Carbon",
      "Blue Fade Patina Carbon",
    ],
    "Blue Fade Clean": ["Blue Fade Dirty", "Blue Fade Patina"],

    "Green Clean Carbon": [
      "Green Dirty Carbon",
      "Green Dirty Patina Carbon",
      "Green Patina Carbon",
    ],
    ...
    "Orange Clean Carbon": [
      "Orange Dirty Carbon",
      "Orange Dirty Patina Carbon",
      "Orange Patina Carbon",
    ],
    "Orange Clean": ["Orange Dirty", "Orange Patina"],

    "Pink Clean Carbon": [
      "Pink Dirty Carbon",
      "Pink Dirty Patina Carbon",
      "Pink Patina Carbon",
    ],
    ...
    "Purple Clean Carbon": [
      "Purple Dirty Carbon",
      "Purple Dirty Patina Carbon",
      "Purple Patina Carbon",
    ],
    "Purple Clean": ["Purple Dirty", "Purple Patina"],

    "Red Clean Carbon": [
      "Red Dirty Carbon",
      "Red Dirty Patina Carbon",
      "Red Patina Carbon",
    ],
    ...
    "Rinbow Clean Carbon": [
      "Rinbow Dirty Carbon",
      "Rinbow Dirty Patina Carbon",
      "Rinbow Patina Carbon",
    ],
    "Rinbow Clean": ["Rinbow Dirty", "Rinbow Patina"],

    "Sunset Clean Carbon": [
      "Sunset Dirty Carbon",
      "Sunset Dirty Patina Carbon",
      "Sunset Patina Carbon",
    ],
    "Sunset Clean": ["Sunset Dirty", "Sunset Patina"],

    "Teal Clean Carbon": [
      "Teal Dirty Carbon",
      "Teal Dirty Patina Carbon",
      "Teal Patina Carbon",
    ],
    ...
    "Yellow Clean Carbon": [
      "Yellow Dirty Carbon",
      "Yellow Dirty Patina Carbon",
      "Yellow Patina Carbon",
    ],
